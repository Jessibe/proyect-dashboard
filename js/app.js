window.addEventListener('load', function() {
  ...
  function promFilter() {
    ...
    if (((studentMeetTarget / totalStudents) * 100).toFixed(1) < 70) {
      ...
      percentOfTotal.style.color = "#f7b617";
    } else if (((studentMeetTarget / totalStudents) * 100).toFixed(1) > 80) {
    ...
    if (((studentTechSkills / totalStudents) * 100).toFixed(2) < 70) {
      ...
      percentTech.style.color = '#FFC300';
    } else if (((studentTechSkills / totalStudents) * 100).toFixed(2) > 80) {
    ...
    if (((studentLifeSkills / totalStudents) * 100).toFixed(2) < 70) {
      ...
      percentLife.style.color = '#FFC300';
    } else if (((studentLifeSkills / totalStudents) * 100).toFixed(2) > 80) {
    ...
    function drawChart() {
      ...
      var chart = new google.visualization.LineChart(document.getElementById('jedi-chart'));
      ...
      var options2 = {'title': 'Rating awarded by the students to their junior and master teachers',
        'width': 500,
        'height': 300,
        'is3D': true};

      var chart2 = new google.visualization.LineChart(document.getElementById('teacher-chart'));
      ...
      var options3 = {'title': 'Surpasses, Meets or Does not Meet LABORATORIA the expectations of the students',
        'width': 500,
        'height': 300,
        'is3D': true};

      var chart3 = new google.visualization.LineChart(document.getElementById('satisfaction-chart'));
      ...
      var options4 = {'title': 'Recommend LABORATORY to other people',
        'width': 500,
        'height': 300,
        'is3D': true};

      var chart4 = new google.visualization.LineChart(document.getElementById('nps-chart'));
      ...
      data5.addRows([
        ['Drop-out', dropout],
        ['Currently enrolled', totalStudents - dropout],
      ]);

      var options5 = {'title': 'Currently enrolled vs drop-out',
        'width': 500,
        'height': 300,
        'is3D': true};

      var chart5 = new google.visualization.ColumnChart(document.getElementById('enrollment-chart'));
      ...
      var options6 = {'title': 'Students who pass the scoring goal established by sprint',
        'width': 500,
        'height': 300,
        'is3D': true};

      var chart6 = new google.visualization.LineChart(document.getElementById('achiv-chart'));
